...
INF_SCHEMA_COLUMNS_NAMES_SET = set(f.name for f in fields(INF_SCHEMA_COLUMNS_NAMES))  # noqa: C401
...
class HandlerResponse:
    ...
    def to_columns_table_response(self, map_type_fn: Callable) -> None:
        ...
        if INF_SCHEMA_COLUMNS_NAMES_SET != current_columns_set:  # noqa: SIM300
            raise ValueError(
